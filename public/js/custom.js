...
===========================*/
	...
	// Temadaki eski uzak sunucuya post eden contact form AJAX'ı devre dışı bırakıldı.
	// Yeni Astro bileşenindeki form kendi fetch + SweetAlert2 akışını kullanıyor.
	// Buradaki handler kaldırılsa da güvenlik için noop bırakıyoruz.
	jQuery(document).off('submit', 'form.cons-contact-form');
